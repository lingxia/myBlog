...
// }
// // axios拦截请求
// axios.interceptors.request.use = instance.interceptors.request.use = instance.interceptors.request.use
...
export default {
  ...
  getArticleLists(params){
    return instance.post('/api/article/articleLists',params);
  },
  // 根据classify获取文章列表
  getArticlesByClassify(params){
    return instance.post('/api/article/noAuthArtilcelists',params);
  },
  // 创建文章
  ...
  getOneArticleNoAuth(params){
    return instance.post('/api/article/noAuth',params);
  },
  // 编辑一篇文章
  editArticle(params){
  ...
  getNoAuthClass(){
    return instance.get('/api/classify/noAuth');
  },
  ...
  //文件上传
  uploadOne(params){
    return instance.post('/api/file/upload',params);
  },
  //文件删除
  deleteOne(params){
    return instance.post('/api/file/delete',params)
  }
}
